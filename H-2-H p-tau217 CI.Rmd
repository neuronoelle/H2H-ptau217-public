...
datafr <- datafr %>% filter(cognitive_status_baseline_variable %in% c("Dementia", "MCI"))
```
...
openxlsx::write.xlsx(final_auc_ab,file="~/Documents/Projects/H-2-H plasma ptau217 assays/Results spreadsheet/bootstrapsAUC_ABPET_CI.xlsx")
...
plot_data$Assay = as.factor(c("%p-tau217WashU", "p-tau217 WashU", "p-tau217 Lilly", "p-tau217 Janssen", "p-tau217 AlzPath", "CSF p-tau217 Lilly","CSF p-tau181/Aβ42 Elecsys", "CSF p-tau181 Elecsys"))
...
openxlsx::write.xlsx(plot_data,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/AB_AUC_table_CI.xlsx")
...
AUC <- ggplot(data = plot_data, aes(x = factor(Assay,levels = c("CSF p-tau181 Elecsys","CSF p-tau181/Aβ42 Elecsys",
  ...
  labs(title = "AUC Aβ-PET CI",x = element_blank(),y = "scaling") +
  theme_classic() +
  theme(axis.text.y = element_text(size = 10),
        axis.text.x = element_text(size = 10),
        panel.border = element_rect(linewidth = 0.5, fill = NA),
        plot.title = element_text(hjust=0.5, size=10, face="bold"))
ggsave("~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/ABPET_ROC_CI.pdf",device = "pdf",width = 125, dpi=500, height = 100, units = "mm")
```
...
openxlsx::write.xlsx(final_auc_ab,file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/bootstraps_Accuracy_ABPET_CI.xlsx")
...
openxlsx::write.xlsx(plot_data,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/AB_Accuracy_table_CI.xlsx")
...
ggsave("~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/ABPET_Accuracy_CI.pdf",device = "pdf",width = 125, dpi=500, height = 100, units = "mm")
...
openxlsx::write.xlsx(final_auc_tau,file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/bootstrapsAUC_TauPET_CI.xlsx")
...
plot_data$table_s <-sprintf("%.3f (%.3f,%.3f)", plot_data$AUC, plot_data$AUC_CIlow, plot_data$AUC_CIhigh)
openxlsx::write.xlsx(plot_data,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/Tau_AUC_table_CI.xlsx")
...
AUC <- ggplot(data = plot_data, aes(x = factor(Assay, 
  ...
  labs(y = y = "scaling",
       x = element_blank(),
       title = "AUC Tau-PET CI") +
  theme_classic() +
  theme(axis.text.y = element_text(size = 10),
        axis.text.x = element_text(size = 10),
        panel.border = element_rect(linewidth = 0.5, fill = NA),
        plot.title = element_text(hjust=0.5, size=10, face="bold"))
ggsave("~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/TauPET_ROC_CI.pdf",device = "pdf",width = 125, dpi=500, height = 100, units = "mm")
```
...
bstau <- function(data, indices, ref, comp) {
  ...
  model2 <- glm(formula2, data = d, family = binomial)
  pred_prob2 <- predict(model2, newdata = d, type = "response")
  roc_curve1 <- roc(d$taupetbin, pred_prob1)
  coordm1 <- coords(roc_curve1, "best", best.method = "youden")
  threshold1 <- coordm1$threshold
  pred_bin1 <- ifelse(pred_prob1 > threshold1, 1, 0)
  roc_curve2 <- roc(d$taupetbin, pred_prob2)
  coordm2 <- coords(roc_curve2, "best", best.method = "youden")
  threshold2 <- coordm2$threshold
  pred_bin2 <- ifelse(pred_prob2 > threshold2, 1, 0)
...
openxlsx::write.xlsx(final_auc_tau,file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/bootstraps_Accuracy_TauPET_CI.xlsx")
...
plot_data$table_s <-sprintf("%.3f (%.3f,%.3f)", plot_data$ACC, plot_data$ACC_CIlow, plot_data$ACC_CIhigh)
openxlsx::write.xlsx(plot_data,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/Tau_ACC_table_CI.xlsx")
...
ggplot(data = plot_data, aes(x = factor(Assay, 
  ...
  labs(y = y = "scaling",
       x = element_blank(),
       title = "Accuracy Tau-PET CI") +
  theme_classic() +
  theme(axis.text.y = element_text(size = 10),
        axis.text.x = element_text(size = 10),
        panel.border = element_rect(linewidth = 0.5, fill = NA),
        plot.title = element_text(hjust=0.5, size=10, face="bold"))
ggsave("~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/TauPET_Accuracy_CI.pdf",device = "pdf",width = 125, dpi=500, height = 100, units = "mm")
...
openxlsx::write.xlsx(finalr2_ab,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/ABPET_R2_CI.xlsx")
...
openxlsx::write.xlsx(table_data,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/AB_R2_table_CI.xlsx")
...
p <- ggplot(data = plot_data, aes(x = factor(Assay, 
  ...
  scale_color_identity(guide = "none") +
  scale_shape_manual(values = my_shapes, guide = "none") +
  labs(title = "Aβ-PET CI", x = element_blank(),y = "Adj. R2 (95% CI)") +
  theme_classic() +
  theme(axis.text.y = element_text(size = 10),
        axis.text.x = element_text(size = 10),
        panel.border = element_rect(linewidth = 0.5, fill = NA),
...
ggsave("~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/ABPET_R2_CI.pdf",device = "pdf",width = 125, dpi=500, height = 100, units = "mm")
...
openxlsx::write.xlsx(finalr2,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/TauPET_R2_CI.xlsx")
...
table_data$table_s <-sprintf("%.3f (%.3f,%.3f)", table_data$R2group2, table_data$ci2_lower, table_data$ci2_upper)
openxlsx::write.xlsx(table_data,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/Tau_R2_table_CI.xlsx")

plot_data <- data.frame(
  Assay = as.factor(c("%p-tau217 WashU", "p-tau217 WashU", "p-tau217 Lilly", "p-tau217 Janssen", "CSF p-tau217 Lilly","CSF p-tau181/Aβ42 Elecsys", "CSF p-tau181 Elecsys")),
...
p <- ggplot(data = plot_data, aes(x = factor(Assay, 
  ...
  scale_color_identity(guide = "none") +
  scale_shape_manual(values = my_shapes, guide = "none") +
 labs(title = "Tau-PET CI", x = element_blank(),y = "Adj. R2 (95% CI)") +
  theme_classic() +
  theme(axis.text.y = element_text(size = 10),
        axis.text.x = element_text(size = 10),
        panel.border = element_rect(linewidth = 0.5, fill = NA),
...
ggsave("~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/TauPET_R2_CI.pdf",device = "pdf",width = 125, dpi=500, height = 100, units = "mm")
```
...
openxlsx::write.xlsx(finalr2_mmse,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/MMSE_R2_CI.xlsx") #A+
...
plot_data$names <- c("%p-tau217 WashU", "p-tau217 WashU", "p-tau217 Lilly", "p-tau217 Janssen", "p-tau217 Alz", "CSF p-tau217 Lilly","CSF p-tau181/Aβ42 Elecsys", "CSF p-tau181 Elecsys")
plot_data$plotcolors = c("1","2", "3", "4", "5", "6", "7", "8")
plot_data$table_s <-sprintf("%.3f (%.3f,%.3f)", plot_data$R2group2, plot_data$ci2_lower, plot_data$ci2_upper)
openxlsx::write.xlsx(plot_data,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/MMSE_R2_table_CI.xlsx")
...
p <- ggplot(data = plot_data, aes(x = factor(Assay, 
  ...
  scale_color_identity(guide = "none") +
  scale_shape_manual(values = my_shapes, guide = "none") +
  labs(title = "MMSE CI", x = element_blank(),y = "Adj. R2 (95% CI)") +
  theme_classic() +
  theme(axis.text.y = element_text(size = 10),
        axis.text.x = element_text(size = 10),
        panel.border = element_rect(linewidth = 0.5, fill = NA),
        plot.title = element_text(hjust=0.5, size=12, face="bold"), 
        axis.title.x = element_text(size=11))
ggsave("~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/MMSE_R2_CI.pdf",device = "pdf",width = 125, dpi=500, height = 100, units = "mm")
...
merged_long <- merged_long %>% filter(cognitive_status_baseline_variable %in% c("Dementia", "MCI"))
...
biomarkers <- c("zscoreswashurref", "zscoreswashuref", "zscoreslilref", "zscoresjansref", "zscoresazl", "zscorescsf217",
                "zscoresptau181_ab42_log", "zscoresptau181")
library(broom)
...
openxlsx::write.xlsx(final_result_boots,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/long_ABPET_R2_CI.xlsx")
...
openxlsx::write.xlsx(table_data,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/ABPET_long_R2_table_CI.xlsx")
...
p6 <-ggplot(data=plot_data, aes(x=factor(Assay,levels = c("CSF p-tau181 Elecsys","CSF p-tau181/Aβ42 Elecsys",  "CSF p-tau217 Lilly", "p-tau217 AlzPath",
  ...
  scale_shape_manual(values = my_shapes,breaks = c("CSF p-tau181 Elecsys","CSF p-tau181/Aβ42 Elecsys",  "CSF p-tau217 Lilly", "p-tau217 AlzPath",
                              "p-tau217 Janssen", "p-tau217 Lilly", "p-tau217 WashU","%p-tau217 WashU"),guide = "none")+
  labs(title = "Aβ-PET (rate of change) CI", x = element_blank(),y = "Adj. R2 (95% CI)") +
  theme_classic() +
  theme(axis.text.y = element_text(size = 10),
        axis.text.x = element_text(size = 10),
        panel.border = element_rect(linewidth = 0.5, fill = NA),
...
ggsave("~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/AB_longitudinal_R2_CI.pdf",device = "pdf",width = 125, dpi=500, height = 100, units = "mm")
  ...
  zref <- biomarkers[i]
    ...
    for (j in (i + 1):length(biomarkers)) {
      ...
      result_df <- data.frame(model = namesvars,
                      ...
                      ci2_r2low = round((ci2r2[1]),7),
                      ci2_r2high = round((ci2r2[2]),7),
                      ci_difference_low_r2 = round(cidiff_r[1],3),
                      ci_difference_high_r2 = round(cidiff_r[2],3))
...
openxlsx::write.xlsx(final_result_boots_tau,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/long_TauPET_boot_R2_CI.xlsx")
...
table_data$table_s <-sprintf("%.3f (%.3f,%.3f)", table_data$r22, table_data$ci2_r2low, table_data$ci2_r2high)
openxlsx::write.xlsx(table_data,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/TauPET_long_R2_table_CI.xlsx")

plot_data <- data.frame(
  Assay = as.factor(c("%p-tau217 WashU", "p-tau217 WashU", "p-tau217 Lilly", "p-tau217 Janssen", "p-tau217 AlzPath", "CSF p-tau217 Lilly","CSF p-tau181/Aβ42 Elecsys", "CSF p-tau181 Elecsys")),
  unique_valuesB = unique(c(final_result_boots_tau$b1, final_result_boots_tau$b2)),
  unique_valuesB_CIlow = unique(c(final_result_boots_tau$ci1_blow, final_result_boots_tau$ci2_blow)),
  unique_valuesB_CIhigh = unique(c(final_result_boots_tau$ci1_bhigh, final_result_boots_tau$ci2_bhigh)),
...
p6 <-ggplot(data=plot_data, aes(x=factor(Assay,level = c("CSF p-tau181 Elecsys","CSF p-tau181/Aβ42 Elecsys","CSF p-tau217 Lilly", "p-tau217 AlzPath",
  ...
  scale_shape_manual(values = my_shapes,
                     breaks = c("CSF p-tau181 Elecsys","CSF p-tau181/Aβ42 Elecsys","CSF p-tau217 Lilly","p-tau217 AlzPath",
                                                   "p-tau217 Janssen","p-tau217 Lilly","p-tau217 WashU","%p-tau217 WashU"),
                     guide = "none")+
  labs(title = "Tau-PET rate of change CI", x = element_blank(),y = "Adj. R2 (95% CI)") +
  theme_classic() +
  theme(axis.text.y = element_text(size = 10),
        axis.text.x = element_text(size = 10),
        panel.border = element_rect(linewidth = 0.5, fill = NA),
        plot.title = element_text(hjust=0.5, size=12, face="bold"), 
        axis.title.x = element_text(size=11))
ggsave("~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/TauPET_longitudinal_R2_CI.pdf",device = "pdf",width = 125, dpi=500, height = 100, units = "mm")
...
openxlsx::write.xlsx(final_result_boots_mmse,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/MMSE_long_R2_CI.xlsx")
...
table_data$table_s <-sprintf("%.3f (%.3f,%.3f)", table_data$r22, table_data$ci2_r2low, table_data$ci2_r2high)
openxlsx::write.xlsx(table_data,
                     file="~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/MMSE_long_R2_table_CI.xlsx")
...
my_palette <- c('#93003a','#93003a','#93003a','#93003a','#0461BD','#0461BD','#0461BD')
...
p6 <-ggplot(data=plot_data, aes(x=factor(Assay,levels = c("CSF p-tau181 Elecsys","CSF p-tau181/Aβ42 Elecsys","CSF p-tau217 Lilly", "p-tau217 AlzPath",
  ...
  scale_shape_manual(values = my_shapes,breaks = c("CSF p-tau181 Elecsys","CSF p-tau181/Aβ42 Elecsys","CSF p-tau217 Lilly","p-tau217 AlzPath",
                                                   "p-tau217 Janssen","p-tau217 Lilly","p-tau217 WashU","%p-tau217 WashU"),
                     guide = "none")+
 labs(title = "MMSE (rate of change) CI", x = element_blank(),y = "Adj. R2 (95% CI)") +
  theme_classic() +
  theme(axis.text.y = element_text(size = 10),
        axis.text.x = element_text(size = 10),
        panel.border = element_rect(linewidth = 0.5, fill = NA),
...
ggsave("~/Documents/Projects/H-2-H plasma ptau217 assays/Final results (incl. AlzPath) CI/MMSE_longitudinal_R2_CI.pdf",device = "pdf",width = 125, dpi=500, height = 100, units = "mm")
